...
class NutritionistProfile extends amplify_core.Model {
  ...
  String toString() {
    ...
    buffer.write("isAvailable=" +
        (_isAvailable != null ? _isAvailable!.toString() : "null") +
        ", ");
  ...
  static final amplify_core
      .QueryModelIdentifier<NutritionistProfileModelIdentifier>
      MODEL_IDENTIFIER =
  ...
  static final SPECIALIZATION =
      amplify_core.QueryField(fieldName: "specialization");
...
class _NutritionistProfileModelType
    extends amplify_core.ModelType<NutritionistProfile> {
 ...
 */
class NutritionistProfileModelIdentifier
    implements amplify_core.ModelIdentifier<NutritionistProfile> {
  final String id;

  /** Create an instance of NutritionistProfileModelIdentifier using [id] the primary key. */
  const NutritionistProfileModelIdentifier({required this.id});
  ...
  bool operator ==(Object other) {
    ...
    return other is NutritionistProfileModelIdentifier && id == other.id;
  }
