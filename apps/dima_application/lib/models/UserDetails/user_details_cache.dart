...
class UserDetailsCache {
  ...
  List<String>?
      allergiesJson; // Store as String list since we can't store enums directly
  int? dailyMealsPreference;
  String?
      exerciseFrequencyString; // Store as String since we can't store enums directly
  double? heightCm;
  String? openTextPreferences;
  String? dietaryRestrictions;
  String?
      updatedAtString; // Store as String since we can't store TemporalDateTime
  double? weightKg;

  /// Creates a cache entry from a UserDetails object
  static UserDetailsCache fromUserDetails(
      UserDetails details, DateTime fetchTime) {
    ...
    return UserDetails(
      ...
      allergies: allergiesJson
          ?.map((e) => AllergenEnum.values.firstWhere(
              ...
              orElse: () => AllergenEnum.values.first))
          .toList(),
