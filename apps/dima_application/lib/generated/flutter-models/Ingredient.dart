...
class Ingredient {
  ...
  const Ingredient._internal(
      {required amount, required macros, required name, unit})
      : _amount = amount,
        _macros = macros,
        _name = name,
        _unit = unit;
  ...
  factory Ingredient(
    ...
    return Ingredient._internal(
        amount: amount, macros: macros, name: name, unit: unit);
  }
  ...
  String toString() {
    ...
    buffer.write(
        "macros=" + (_macros != null ? _macros!.toString() : "null") + ", ");
  ...
  Ingredient copyWith(
      {double? amount, Macros? macros, String? name, String? unit}) {
    return Ingredient._internal(
  ...
  Map<String, dynamic> toJson() => {
        'amount': _amount,
        'macros': _macros?.toJson(),
        'name': _name,
        'unit': _unit
      };

  Map<String, Object?> toMap() =>
      {'amount': _amount, 'macros': _macros, 'name': _name, 'unit': _unit};
