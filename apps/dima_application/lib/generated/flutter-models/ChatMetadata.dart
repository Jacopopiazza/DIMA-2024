...
class ChatMetadata extends amplify_core.Model {
  ...
  ChatMetadataModelIdentifier get modelIdentifier {
      return ChatMetadataModelIdentifier(
        id: id
      );
  }
  ...
  const ChatMetadata._internal({required this.id, required chatId, createdAt, lastMessageSnippet, lastMessageTimestamp, required mealPlanId, nutritionistGivenName, required nutritionistId, nutritionistUnreadCount, planName, userGivenName, required userId, userUnreadCount, updatedAt}): _chatId = chatId, _createdAt = createdAt, _lastMessageSnippet = lastMessageSnippet, _lastMessageTimestamp = lastMessageTimestamp, _mealPlanId = mealPlanId, _nutritionistGivenName = nutritionistGivenName, _nutritionistId = nutritionistId, _nutritionistUnreadCount = nutritionistUnreadCount, _planName = planName, _userGivenName = userGivenName, _userId = userId, _userUnreadCount = userUnreadCount, _updatedAt = updatedAt;
  
  factory ChatMetadata({String? id, required String chatId, amplify_core.TemporalDateTime? createdAt, String? lastMessageSnippet, amplify_core.TemporalDateTime? lastMessageTimestamp, required String mealPlanId, String? nutritionistGivenName, required String nutritionistId, int? nutritionistUnreadCount, String? planName, String? userGivenName, required String userId, int? userUnreadCount}) {
  ...
  String toString() {
    ...
    buffer.write("nutritionistUnreadCount=" + (_nutritionistUnreadCount != null ? _nutritionistUnreadCount!.toString() : "null") + ", ");
    buffer.write("planName=" + "$_planName" + ", ");
    buffer.write("userGivenName=" + "$_userGivenName" + ", ");
    buffer.write("userId=" + "$_userId" + ", ");
    buffer.write("userUnreadCount=" + (_userUnreadCount != null ? _userUnreadCount!.toString() : "null") + ", ");
  ...
  ChatMetadata copyWith({String? chatId, amplify_core.TemporalDateTime? createdAt, String? lastMessageSnippet, amplify_core.TemporalDateTime? lastMessageTimestamp, String? mealPlanId, String? nutritionistGivenName, String? nutritionistId, int? nutritionistUnreadCount, String? planName, String? userGivenName, String? userId, int? userUnreadCount}) {
    return ChatMetadata._internal(
      id: id,
      ...
      nutritionistGivenName: nutritionistGivenName ?? this.nutritionistGivenName,
      nutritionistId: nutritionistId ?? this.nutritionistId,
      nutritionistUnreadCount: nutritionistUnreadCount ?? this.nutritionistUnreadCount,
  ...
  ChatMetadata copyWithModelFieldValues({
    ...
    return ChatMetadata._internal(
      ...
      lastMessageSnippet: lastMessageSnippet == null ? this.lastMessageSnippet : lastMessageSnippet.value,
      ...
      nutritionistGivenName: nutritionistGivenName == null ? this.nutritionistGivenName : nutritionistGivenName.value,
      nutritionistId: nutritionistId == null ? this.nutritionistId : nutritionistId.value,
      nutritionistUnreadCount: nutritionistUnreadCount == null ? this.nutritionistUnreadCount : nutritionistUnreadCount.value,
      planName: planName == null ? this.planName : planName.value,
      userGivenName: userGivenName == null ? this.userGivenName : userGivenName.value,
      userId: userId == null ? this.userId : userId.value,
      userUnreadCount: userUnreadCount == null ? this.userUnreadCount : userUnreadCount.value
    );
  }
  ...
  ChatMetadata.fromJson(Map<String, dynamic> json)  
    : id = json['id'],
      ...
      _nutritionistUnreadCount = (json['nutritionistUnreadCount'] as num?)?.toInt(),
  ...
  Map<String, dynamic> toJson() => {
    'id': id, 'chatId': _chatId, 'createdAt': _createdAt?.format(), 'lastMessageSnippet': _lastMessageSnippet, 'lastMessageTimestamp': _lastMessageTimestamp?.format(), 'mealPlanId': _mealPlanId, 'nutritionistGivenName': _nutritionistGivenName, 'nutritionistId': _nutritionistId, 'nutritionistUnreadCount': _nutritionistUnreadCount, 'planName': _planName, 'userGivenName': _userGivenName, 'userId': _userId, 'userUnreadCount': _userUnreadCount, 'updatedAt': _updatedAt?.format()
  };
  ...
  static final amplify_core.QueryModelIdentifier<ChatMetadataModelIdentifier> MODEL_IDENTIFIER = amplify_core.QueryModelIdentifier<ChatMetadataModelIdentifier>();
  static final ID = amplify_core.QueryField(fieldName: "id");
  static final CHATID = amplify_core.QueryField(fieldName: "chatId");
  static final CREATEDAT = amplify_core.QueryField(fieldName: "createdAt");
  static final LASTMESSAGESNIPPET = amplify_core.QueryField(fieldName: "lastMessageSnippet");
  ...
  static final NUTRITIONISTGIVENNAME = amplify_core.QueryField(fieldName: "nutritionistGivenName");
  static final NUTRITIONISTID = amplify_core.QueryField(fieldName: "nutritionistId");
  static final NUTRITIONISTUNREADCOUNT = amplify_core.QueryField(fieldName: "nutritionistUnreadCount");
  static final PLANNAME = amplify_core.QueryField(fieldName: "planName");
  static final USERGIVENNAME = amplify_core.QueryField(fieldName: "userGivenName");
  static final USERID = amplify_core.QueryField(fieldName: "userId");
  static final USERUNREADCOUNT = amplify_core.QueryField(fieldName: "userUnreadCount");
 ...
 */
class ChatMetadataModelIdentifier implements amplify_core.ModelIdentifier<ChatMetadata> {
  final String id;

  /** Create an instance of ChatMetadataModelIdentifier using [id] the primary key. */
  const ChatMetadataModelIdentifier({
    required this.id});
  ...
  bool operator ==(Object other) {
    ...
    return other is ChatMetadataModelIdentifier &&
      id == other.id;
  }
