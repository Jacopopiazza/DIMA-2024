...
class UserDetails extends amplify_core.Model {
  ...
  UserDetailsModelIdentifier get modelIdentifier {
    try {
      return UserDetailsModelIdentifier(userId: _userId!);
    } catch (e) {
  ...
  const UserDetails._internal(
      {activeMealPlanId,
      allergies,
      createdAt,
      required dailyMealsPreference,
      dietaryRestrictions,
      required exerciseFrequency,
      required heightCm,
      openTextPreferences,
      updatedAt,
      required userId,
      required weightKg})
      : _activeMealPlanId = activeMealPlanId,
        _allergies = allergies,
        _createdAt = createdAt,
        _dailyMealsPreference = dailyMealsPreference,
        _dietaryRestrictions = dietaryRestrictions,
        _exerciseFrequency = exerciseFrequency,
        _heightCm = heightCm,
        _openTextPreferences = openTextPreferences,
  ...
  factory UserDetails(
      ...
      List<AllergenEnum>? allergies,
      amplify_core.TemporalDateTime? createdAt,
      required int dailyMealsPreference,
    ...
    return UserDetails._internal(
        ...
        allergies: allergies != null
            ? List<AllergenEnum>.unmodifiable(allergies)
            : allergies,
        createdAt: createdAt,
  ...
  String toString() {
    ...
    buffer.write("allergies=" +
        (_allergies != null
            ? _allergies!.map((e) => amplify_core.enumToString(e)).toString()
            : "null") +
        ", ");
    buffer.write("createdAt=" +
        (_createdAt != null ? _createdAt!.format() : "null") +
        ", ");
    buffer.write("dailyMealsPreference=" +
        (_dailyMealsPreference != null
            ? _dailyMealsPreference!.toString()
            : "null") +
        ", ");
    buffer.write("dietaryRestrictions=" + "$_dietaryRestrictions" + ", ");
    buffer.write("exerciseFrequency=" +
        (_exerciseFrequency != null
            ? amplify_core.enumToString(_exerciseFrequency)!
            : "null") +
        ", ");
    buffer.write("heightCm=" +
        (_heightCm != null ? _heightCm!.toString() : "null") +
        ", ");
    ...
    buffer.write(
        "weightKg=" + (_weightKg != null ? _weightKg!.toString() : "null"));
    buffer.write("}");
  ...
  UserDetails copyWithModelFieldValues(
    ...
    return UserDetails._internal(
        activeMealPlanId: activeMealPlanId == null
            ? this.activeMealPlanId
            : activeMealPlanId.value,
        allergies: allergies == null ? this.allergies : allergies.value,
        createdAt: createdAt == null ? this.createdAt : createdAt.value,
        dailyMealsPreference: dailyMealsPreference == null
            ? this.dailyMealsPreference
            : dailyMealsPreference.value,
        ...
        openTextPreferences: openTextPreferences == null
            ? this.openTextPreferences
            : openTextPreferences.value,
      ...
      : _activeMealPlanId = json['activeMealPlanId'],
        _allergies = json['allergies'] is List
            ? (json['allergies'] as List)
                .map((e) => amplify_core.enumFromString<AllergenEnum>(
                    e, AllergenEnum.values)!)
                .toList()
            : null,
        ...
        _exerciseFrequency = amplify_core.enumFromString<ExerciseFrequency>(
            json['exerciseFrequency'], ExerciseFrequency.values),
  ...
  Map<String, dynamic> toJson() => {
        ...
        'allergies':
            _allergies?.map((e) => amplify_core.enumToString(e)).toList(),
        'createdAt': _createdAt?.format(),
        'dailyMealsPreference': _dailyMealsPreference,
        'dietaryRestrictions': _dietaryRestrictions,
        'exerciseFrequency': amplify_core.enumToString(_exerciseFrequency),
        'heightCm': _heightCm,
  ...
  static final amplify_core.QueryModelIdentifier<UserDetailsModelIdentifier>
      MODEL_IDENTIFIER =
      amplify_core.QueryModelIdentifier<UserDetailsModelIdentifier>();
  static final ACTIVEMEALPLANID =
      amplify_core.QueryField(fieldName: "activeMealPlanId");
  static final ALLERGIES = amplify_core.QueryField(fieldName: "allergies");
  static final CREATEDAT = amplify_core.QueryField(fieldName: "createdAt");
  static final DAILYMEALSPREFERENCE =
      amplify_core.QueryField(fieldName: "dailyMealsPreference");
  static final DIETARYRESTRICTIONS =
      amplify_core.QueryField(fieldName: "dietaryRestrictions");
  static final EXERCISEFREQUENCY =
      amplify_core.QueryField(fieldName: "exerciseFrequency");
  static final HEIGHTCM = amplify_core.QueryField(fieldName: "heightCm");
  static final OPENTEXTPREFERENCES =
      amplify_core.QueryField(fieldName: "openTextPreferences");
 ...
 */
class UserDetailsModelIdentifier
    implements amplify_core.ModelIdentifier<UserDetails> {
  final String userId;

  /** Create an instance of UserDetailsModelIdentifier using [userId] the primary key. */
  const UserDetailsModelIdentifier({required this.userId});
  ...
  bool operator ==(Object other) {
    ...
    return other is UserDetailsModelIdentifier && userId == other.userId;
  }
