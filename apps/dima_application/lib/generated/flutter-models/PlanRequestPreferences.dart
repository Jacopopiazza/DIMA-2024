...
class PlanRequestPreferences {
  ...
  const PlanRequestPreferences._internal(
      {allergies,
  ...
  factory PlanRequestPreferences(
      ...
      required amplify_core.TemporalDate dateOfBirth,
  ...
  PlanRequestPreferences copyWith(
      {List<AllergenEnum>? allergies,
      int? dailyMealsPreference,
      amplify_core.TemporalDate? dateOfBirth,
      String? dietaryRestrictions,
      ExerciseFrequency? exerciseFrequency,
      String? gender,
      double? heightCm,
  ...
  PlanRequestPreferences.fromJson(Map<String, dynamic> json)
      : _allergies = json['allergies'] is List
        ...
        _dateOfBirth = json['dateOfBirth'] != null
            ? amplify_core.TemporalDate.fromString(json['dateOfBirth'])
            : null,
