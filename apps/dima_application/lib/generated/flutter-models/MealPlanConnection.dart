...
class MealPlanConnection {
  ...
  const MealPlanConnection._internal({required items, nextToken}): _items = items, _nextToken = nextToken;
  
  factory MealPlanConnection({required List<MealPlan> items, String? nextToken}) {
  ...
  MealPlanConnection copyWith({List<MealPlan>? items, String? nextToken}) {
    return MealPlanConnection._internal(
  ...
  Map<String, dynamic> toJson() => {
    'items': _items?.map((MealPlan? e) => e?.toJson()).toList(), 'nextToken': _nextToken
  };
