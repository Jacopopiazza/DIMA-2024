...
class ChatMessage extends amplify_core.Model {
  ...
  const ChatMessage._internal({required this.id, required chatId, required messageContent, required messageId, required senderId, required senderType, required sentAt, createdAt, updatedAt}): _chatId = chatId, _messageContent = messageContent, _messageId = messageId, _senderId = senderId, _senderType = senderType, _sentAt = sentAt, _createdAt = createdAt, _updatedAt = updatedAt;
  
  factory ChatMessage({String? id, required String chatId, required String messageContent, required String messageId, required String senderId, required SenderType senderType, required amplify_core.TemporalDateTime sentAt}) {
  ...
  String toString() {
    ...
    buffer.write("senderType=" + (_senderType != null ? amplify_core.enumToString(_senderType)! : "null") + ", ");
    buffer.write("sentAt=" + (_sentAt != null ? _sentAt!.format() : "null") + ", ");
  ...
  ChatMessage copyWith({String? chatId, String? messageContent, String? messageId, String? senderId, SenderType? senderType, amplify_core.TemporalDateTime? sentAt}) {
    return ChatMessage._internal(
      id: id,
  ...
  ChatMessage copyWithModelFieldValues({
    ...
    return ChatMessage._internal(
      ...
      messageContent: messageContent == null ? this.messageContent : messageContent.value,
  ...
  ChatMessage.fromJson(Map<String, dynamic> json)  
    : id = json['id'],
      ...
      _senderType = amplify_core.enumFromString<SenderType>(json['senderType'], SenderType.values),
      _sentAt = json['sentAt'] != null ? amplify_core.TemporalDateTime.fromString(json['sentAt']) : null,
      _createdAt = json['createdAt'] != null ? amplify_core.TemporalDateTime.fromString(json['createdAt']) : null,
      _updatedAt = json['updatedAt'] != null ? amplify_core.TemporalDateTime.fromString(json['updatedAt']) : null;
  
  Map<String, dynamic> toJson() => {
    'id': id, 'chatId': _chatId, 'messageContent': _messageContent, 'messageId': _messageId, 'senderId': _senderId, 'senderType': amplify_core.enumToString(_senderType), 'sentAt': _sentAt?.format(), 'createdAt': _createdAt?.format(), 'updatedAt': _updatedAt?.format()
  };
  ...
  static final MESSAGECONTENT = amplify_core.QueryField(fieldName: "messageContent");
