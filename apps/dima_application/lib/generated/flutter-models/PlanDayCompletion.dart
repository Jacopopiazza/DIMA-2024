...
class PlanDayCompletion extends amplify_core.Model {
  ...
  PlanDayCompletionModelIdentifier get modelIdentifier {
      return PlanDayCompletionModelIdentifier(
        id: id
      );
  }
  ...
  const PlanDayCompletion._internal({required this.id, required completedMealNames, required date, required planId, required updatedAt, required userId, createdAt}): _completedMealNames = completedMealNames, _date = date, _planId = planId, _updatedAt = updatedAt, _userId = userId, _createdAt = createdAt;
  
  factory PlanDayCompletion({String? id, required List<MealNameEnum> completedMealNames, required amplify_core.TemporalDate date, required String planId, required amplify_core.TemporalDateTime updatedAt, required String userId}) {
    return PlanDayCompletion._internal(
      id: id == null ? amplify_core.UUID.getUUID() : id,
      completedMealNames: completedMealNames != null ? List<MealNameEnum>.unmodifiable(completedMealNames) : completedMealNames,
      date: date,
      planId: planId,
      updatedAt: updatedAt,
      userId: userId);
  ...
  bool operator ==(Object other) {
    ...
    return other is PlanDayCompletion &&
      id == other.id &&
      DeepCollectionEquality().equals(_completedMealNames, other._completedMealNames) &&
      _date == other._date &&
  ...
  String toString() {
    ...
    buffer.write("id=" + "$id" + ", ");
    buffer.write("completedMealNames=" + (_completedMealNames != null ? _completedMealNames!.map((e) => amplify_core.enumToString(e)).toString() : "null") + ", ");
  ...
  PlanDayCompletion copyWith({List<MealNameEnum>? completedMealNames, amplify_core.TemporalDate? date, String? planId, amplify_core.TemporalDateTime? updatedAt, String? userId}) {
    return PlanDayCompletion._internal(
      id: id,
  ...
  PlanDayCompletion copyWithModelFieldValues({
    ...
    return PlanDayCompletion._internal(
      id: id,
      completedMealNames: completedMealNames == null ? this.completedMealNames : completedMealNames.value,
    ...
    : id = json['id'],
      _completedMealNames = json['completedMealNames'] is List
        ? (json['completedMealNames'] as List)
          .map((e) => amplify_core.enumFromString<MealNameEnum>(e, MealNameEnum.values)!)
          .toList()
        : null,
  ...
  Map<String, dynamic> toJson() => {
    'id': id, 'completedMealNames': _completedMealNames?.map((e) => amplify_core.enumToString(e)).toList(), 'date': _date?.format(), 'planId': _planId, 'updatedAt': _updatedAt?.format(), 'userId': _userId, 'createdAt': _createdAt?.format()
  };
  ...
  static final amplify_core.QueryModelIdentifier<PlanDayCompletionModelIdentifier> MODEL_IDENTIFIER = amplify_core.QueryModelIdentifier<PlanDayCompletionModelIdentifier>();
  static final ID = amplify_core.QueryField(fieldName: "id");
  static final COMPLETEDMEALNAMES = amplify_core.QueryField(fieldName: "completedMealNames");
...
class _PlanDayCompletionModelType extends amplify_core.ModelType<PlanDayCompletion> {
 ...
 */
class PlanDayCompletionModelIdentifier implements amplify_core.ModelIdentifier<PlanDayCompletion> {
  final String id;

  /** Create an instance of PlanDayCompletionModelIdentifier using [id] the primary key. */
  const PlanDayCompletionModelIdentifier({
    required this.id});
  ...
  bool operator ==(Object other) {
    ...
    return other is PlanDayCompletionModelIdentifier &&
      id == other.id;
  }
