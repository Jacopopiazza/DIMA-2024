  ...
  group('DailyCompletion', () {
    ...
    group('Factory constructor forDate', () {
      ...
      test('uses current time as default latestUpdate', () {
        ...
        expect(
            completion.latestUpdate.isAfter(beforeCreation) ||
                completion.latestUpdate.isAtSameMomentAs(beforeCreation),
            isTrue);
        expect(
            completion.latestUpdate.isBefore(afterCreation) ||
                completion.latestUpdate.isAtSameMomentAs(afterCreation),
            isTrue);
      });
      ...
      test('handles duplicate meals in list', () {
        ...
        expect(
            completion.completedMealNames
                .where((meal) => meal == MealNameEnum.BREAKFAST)
                .length,
            2);
      });
    });
